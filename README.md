...
```
```
#How to use filter after groupby (filtering on index)
my_list = [45111510,45111530,45111605,45111635,45111650,45111660,45111671,45111672,45111680,45111691,45111692,45111701,45111702,
45111703,45111711,45111712,45111713,45111714,45111730,45113525,45113540,45113550,45113560,45113570,45113580,45113590,45113600,
45113611,45113612,45113620,45113641,45113642,45113650,45113660,45113670]
...
```
```
# when dd.read_csv() keeps getting error on encoding
csv_lst_2021 = glob('Z:/03. 데이터/06. 전라북도 분석데이터/2023 전라북도 빅데이터 분석사업/1. 유동인구/01. 21년 생활인구/압축해제/*/*.csv')
csv_lst_2021 = csv_lst_2021[8:9]
